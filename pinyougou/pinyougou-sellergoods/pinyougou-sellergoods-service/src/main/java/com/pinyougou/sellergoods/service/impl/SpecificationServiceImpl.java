...
public class SpecificationServiceImpl extends BaseServiceImpl<TbSpecification> implements SpecificationService {
    ...
    public void update(Specification specification) {
        ...
        TbSpecification param = specification.getSpecification();

        TbSpecificationOption tbSpecificationOption = new TbSpecificationOption();
        tbSpecificationOption.setSpecId(param.getId());
    ...
    public void deleteSpecificationByIds(Long[] ids) {
        /*for (Long id : ids) {
            ...
            TbSpecificationOption tbSpecificationOption = specificationOptionMapper.selectByPrimaryKey(id);
            specificationOptionMapper.delete(tbSpecificationOption);
